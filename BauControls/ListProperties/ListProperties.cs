...
namespace Bau.Controls.ListProperties
{
	...
	{ 	
		...
		/// </summary>
		public void AddControl(string strKey, ControlType type, string title, string value, bool blnRequired)
		{ ControlProperty udtResult = new ControlProperty();
		
				// Carga los datos
					udtResult.LoadValue(strKey, type, title, value, blnRequired);
